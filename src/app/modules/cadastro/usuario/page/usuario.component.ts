...
import { DropDownEnumOptions } from '../../../../models/Interfaces/usuario/DropDownEnumOptions.interface';
 ...
 */
  public userSelected!: Usuario | null;
 ...
 */
  ...
  onDisableButtonClick(usuario: Usuario): void {
    this.userForm.patchValue({
      codigo: usuario.codigo,
    });
